...
export type Action='read'|'submit_evidence'|'request_clarification'|'draft_label'|'publish_asset'|'register_object'|'publish_label'|'open_return_review'|'delete_evidence'|'physical_return';
