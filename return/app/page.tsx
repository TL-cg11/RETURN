...
const objects = [
  { number: '01', title: 'Moonbird Mask', date: 'c. 1930', note: '20-year record gap', tone: 'clay' },
  { number: '02', title: 'Riverstone Vessel', date: 'c. 1912', note: 'Community context added', tone: 'stone' },
  { number: '03', title: 'Woven Signal Cloth', date: '1946', note: 'Attribution under review', tone: 'indigo' },
];
    ...
    <main>
      ...
      <section className="hero" aria-labelledby="hero-title">
        <div className="hero-copy">
          ...
          <div className="hero-actions">
            <Link className="primary-action" href="/objects/moonbird-mask">Explore the Moonbird Mask <span aria-hidden="true">→</span></Link>
        ...
        <div className="featured-object" aria-label="Featured object: Moonbird Mask">
          <div className="catalog-mark">Featured object <span>RT.1930.014</span></div>
          ...
          <div className="object-caption">
            <div><p className="caption-kicker">Object 01</p><h2>Moonbird Mask</h2></div>
            <div className="record-status"><span className="status-dot" /><span>Record open<br /><strong>3 questions</strong></span></div>
          </div>
        </div>
      </section>

      <section className="record-strip" aria-label="Collection record summary">
        <div><strong>08</strong><span>Objects in this collection</span></div>
        <div><strong>03</strong><span>Open provenance gaps</span></div>
        <div><strong>05</strong><span>Community contributions</span></div>
      ...
      <section className="collection" id="collection" aria-labelledby="collection-title">
        <div className="section-heading">
          <div><p className="eyebrow">Selected records</p><h2 id="collection-title">The collection is still being written.</h2></div>
          <p>Each record shows what is known, what is attributed, and what remains an open question.</p>
        </div>
        <div className="object-list">
          {objects.map((object) => (
            <Link className="object-row" href={object.number === '01' ? '/objects/moonbird-mask' : '#'} key={object.number}>
              <span className="object-number">{object.number}</span>
              ...
              <span className="object-note">{object.note}</span><span className="row-arrow" aria-hidden="true">↗</span>
            </Link>
          ))}
        </div>
      </section>
