...
const evidence: SeedEvidence[] = [
  // One verified record per object (MCP-E6). Every object but the Moonbird Mask used to
  // hold no evidence at all, and the gateway requires a verified citation for any
  // official change: a curator agent could not propose a label revision on seven of the
  // eight records, and the refusal blamed the evidence rather than the empty shelf.
  // These are accession-register entries, which is what a museum actually holds for an
  // object with a settled acquisition. On records with an open gap the entry says what
  // the register does not cover, so citing it cannot close a gap by implication.
  { id: 'EV-ACC-1912', objectId: 'riverstone-vessel', type: 'Accession record', title: '1912 accession record', body: 'Register entry records receipt from the Vale survey collection in 1912, with the donor named.', sourceName: 'Museum accession register', sourceRelationship: 'Museum accession file', date: '1912', place: 'Upper Vale', authority: 'verified', consent: 'public_attributed', visibility: 'public', submittedBy: 'Museum registrar', verifiedBy: 'Mina, Curator' },
  { id: 'EV-ACC-1952', objectId: 'woven-signal-cloth', type: 'Accession record', title: '1952 accession record', body: 'Register entry records receipt in 1952. No custodian is named for the years before it.', sourceName: 'Museum accession register', sourceRelationship: 'Museum accession file', date: '1952', place: 'North Channel', authority: 'verified', consent: 'public_attributed', visibility: 'public', submittedBy: 'Museum registrar', verifiedBy: 'Mina, Curator' },
  { id: 'EV-ACC-1888', objectId: 'tide-listening-stone', type: 'Accession record', title: '1888 accession record', body: 'Register entry records receipt in 1888 from the founding bequest, with the bequest number.', sourceName: 'Museum accession register', sourceRelationship: 'Museum accession file', date: '1888', place: 'West Shoals', authority: 'verified', consent: 'public_attributed', visibility: 'public', submittedBy: 'Museum registrar', verifiedBy: 'Mina, Curator' },
  { id: 'EV-ACC-1934', objectId: 'reed-memory-box', type: 'Accession record', title: '1934 accession record', body: 'Register entry records receipt in 1934. The years between making and receipt are not documented.', sourceName: 'Museum accession register', sourceRelationship: 'Museum accession file', date: '1934', place: 'Aru delta', authority: 'verified', consent: 'public_attributed', visibility: 'public', submittedBy: 'Museum registrar', verifiedBy: 'Mina, Curator' },
  { id: 'EV-ACC-1904', objectId: 'four-winds-bowl', type: 'Accession record', title: '1904 accession record', body: 'Register entry records purchase in 1904, with the seller and the price.', sourceName: 'Museum accession register', sourceRelationship: 'Museum accession file', date: '1904', place: 'Lowland route', authority: 'verified', consent: 'public_attributed', visibility: 'public', submittedBy: 'Museum registrar', verifiedBy: 'Mina, Curator' },
  { id: 'EV-ACC-1962', objectId: 'dawn-marker', type: 'Accession record', title: '1962 accession record', body: 'Register entry records commission and receipt in 1962, with the maker named.', sourceName: 'Museum accession register', sourceRelationship: 'Museum accession file', date: '1962', place: 'East Ridge', authority: 'verified', consent: 'public_attributed', visibility: 'public', submittedBy: 'Museum registrar', verifiedBy: 'Mina, Curator' },
  { id: 'EV-ACC-1951', objectId: 'harbor-thread-map', type: 'Accession record', title: '1951 accession record', body: 'Register entry records receipt in 1951. Wartime custody is not documented in the register.', sourceName: 'Museum accession register', sourceRelationship: 'Museum accession file', date: '1951', place: 'Old Harbor', authority: 'verified', consent: 'public_attributed', visibility: 'public', submittedBy: 'Museum registrar', verifiedBy: 'Mina, Curator' },
